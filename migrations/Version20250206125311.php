 ...
 */
final class Version20250206125311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_game ADD category_id INT NOT NULL, ADD editor_id INT NOT NULL, DROP id_category_id, DROP id_editor_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_game ADD id_category_id INT NOT NULL, ADD id_editor_id INT NOT NULL, DROP category_id, DROP editor_id');
